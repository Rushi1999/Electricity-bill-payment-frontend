import { getEmpByIdService, getAllEmpsService } from "./services/EmpServices";
      ...
      <div className="col-4 border border-light shadow p-3 mb-5 bg-white">
        ...
        >
          <input
            ...
            value={eid}
            onChange={handleEmp}
            placeholder="Enter eid to search"
            autoFocus
            required
          />
          <input
        ...
        <p>
          Data from store: {empDataFromStore.eid} {empDataFromStore.firstName}{" "}
          {empDataFromStore.salary}
        </p>
      </div>
